...
# We're not interested in the grey module (it's not a true WGCNA module)
dirs = setdiff(dirs, "grey")
...
novo_motif_matches$module = gsub("\\..*","",rownames(novo_motif_matches))
novo_motif_table$module = gsub("\\..*","",rownames(novo_motif_table))
known_motif_table$module = gsub("\\..*","",rownames(known_motif_table))
...
novo_motif_matches = novo_motif_matches[c("motif_name", "rank", "score", "offset",    "orientation", 
                                          "original_alignment",    "matched_alignment",   "motif", "module", "TF","inference")]

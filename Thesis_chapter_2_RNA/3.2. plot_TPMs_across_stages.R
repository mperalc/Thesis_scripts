...
## ## ## ## CHANGES EVERY TIME ## ## ## ##
genes = c("POU5F1", "SOX17", "FOXA2","PDX1", "NKX6-1", "NKX2-2", "NEUROG3", "MAFA", "MAFB",
          "INS", "ABCC8", "G6PC2", "GLP1R", "KCNJ11", "GCK", "SLC2A2", "GIPR", "SLC30A8")
# vector of genes to plot
output_name = "ESM_Figure_2"
output_type = "multiple_png"  # can be: 'png', 'tiff', 'multiple_png', 'multiple_tiff', 'pdf'
...
if (output_type == "multiple_png" | output_type == "multiple_tiff" ) {
    ...
    if (output_type == "multiple_png") {
      ...
      png(paste(output_name, ".png", sep = ""), type = "cairo", antialias = "default", width = 14, height = 18, units = "in", res = 600, pointsize = 13)
      print(p)
      dev.off()
    }

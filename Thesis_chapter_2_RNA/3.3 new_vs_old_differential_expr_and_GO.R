...
# Differential expression analysis of old vs new data (creates tables used in ESM Table 7) and gene ontology analysis
...
compEnrich <- compareCluster(geneCluster   = sig_genes_with_go,
                             fun           = "enrichGO",
                             pvalueCutoff  = 0.05,
                             pAdjustMethod = "BH",
                             OrgDb = 'org.Hs.eg.db',
                             universe = all_with_go,
                             readable = T)
compEnrich_pathway <- compareCluster(geneCluster   = sig_genes_with_go,
                             fun           = "enrichPathway",
                             pvalueCutoff  = 0.05,
                             pAdjustMethod = "BH",
                             universe = all_with_go,
...
write.table(compEnrich_pathway@compareClusterResult[compEnrich_pathway@compareClusterResult$Cluster=="ENstage6",],
            file = "pathway_analysis_newvsold_EN.txt",
